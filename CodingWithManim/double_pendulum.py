...
from pendulum_chaos import Pendulum
...
class DoublePendulum(VMobject):
    ...
    def _update_pos(self, theta1, theta2):
        ...
        self.pendulum2.rod.put_start_and_end_on(self.pendulum1.bob.get_center(), bob2_pos)
    ...
    def update_pendulum(self, dt):
        ...
        num3 = -2 * sin(self.theta1 - self.theta2) * m2 * \
            (self.omega1 ** 2 * l2 + self.omega1 ** 2 * l1 * cos(self.theta1 - self.theta2))
